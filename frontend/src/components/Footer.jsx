const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white text-sm py-2">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        {/* Left Section */}
        <div className="text-center md:text-left">
          <h2 className="text-base font-semibold">PharmaTrack</h2>
          <p> © {new Date().getFullYear()} PharmaTrack. All rights reserved. </p>
        </div>
        ...
        <div className="text-center md:text-right mt-4 md:mt-0">
          <p>
            Contact Us:{" "}
            <span className="font-semibold">support@pharmatrack.com</span>
          </p>
          <p>
            Phone: <span className="font-semibold">+880 123-456-789</span>
          </p>
        </div>
      </div>
    </footer>
